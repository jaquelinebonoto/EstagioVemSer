...
public class AppRunner implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        jdbcTemplate.update("INSERT INTO app_user (id, first_name, last_name, password, username) VALUES (S_USER.NEXTVAL, 'John', 'Doe', '$2a$10$qtH0F1m488673KwgAfFXEOWxsoZSeHqqlB/8BTt3a6gsI5c2mdlfe', 'john.doe')");
        jdbcTemplate.update("INSERT INTO app_user (id, first_name, last_name, password, username) VALUES (S_USER.NEXTVAL, 'Admin', 'Admin', '$2a$10$qtH0F1m488673KwgAfFXEOWxsoZSeHqqlB/8BTt3a6gsI5c2mdlfe', 'admin.admin')");
